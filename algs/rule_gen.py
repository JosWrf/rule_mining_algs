...
def generate_rules(frequent_itemsets: DataFrame, min_conf: float = 0.5) -> DataFrame:
    ...
    """
    # TODO: Change the implementation of a priori and ais to store tuples instead of lists
    support_mapping = {
    ...
    def __ap_genrules(
    ...
    ) -> Iterator[Dict[Tuple[str], Tuple[str], float, float]]:
        ...
        Yields:
            Iterator[Dict[Tuple[str], Tuple[str], float, float]]: Rule[antecedent, consequent, confidence, support]
        """
        new_consequents = []
